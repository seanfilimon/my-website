...
export default function ResourcesPage() {
  ...
  // GSAP Animations and smooth scroll - same as landing page
  useEffect(() => {
    ...
    // Create page entrance timeline - minimal delay for sync
    const tl = gsap.timeline({ delay: 0.1 });

    // Sidebar slide in from left - starts at 0.1s
    tl.fromTo(
    ...
    // Breadcrumb fade in - overlaps with sidebar
    .fromTo(
      ".breadcrumb-section",
      { opacity: 0, y: -15 },
      {
      ...
      "-=0.3" // Start shortly after sidebar begins
    );
  ...
  return (
    <div className="flex w-full h-full overflow-hidden">
      ...
      {/* Sidebar - responsive, sticky within container */}
      <aside className={`
        resources-sidebar-wrapper
        fixed lg:sticky left-0 top-0 h-full w-72 z-50 shrink-0
      ...
      {/* Main Content Area - flexible and responsive with constrained height */}
      <main ref={sectionRef} className="resources-content flex-1 min-w-0 h-full overflow-y-auto overflow-x-hidden">
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="w-full">
            ...
            <div className="articles-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
