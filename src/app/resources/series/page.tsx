        ...
        <div className="sticky top-0 z-10 border-b bg-background/95 backdrop-blur">
          <div className="w-full px-4 py-4">
            <div className="relative">
              ...
              <input type="search" placeholder="Search series..." className="w-full pl-9 pr-3 py-2 text-sm rounded-sm border focus:outline-none focus:ring-2 focus:ring-primary/20" />
            </div>
          </div>
        </div>

        <div className="py-8 px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold mb-6">Content Series</h2>
